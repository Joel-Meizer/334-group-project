  ...
  <div v-else>
    ...
    <form style="padding: 50px; background-color: white; border-radius: 10px; box-shadow: 1px 5px 8px grey; margin-left: 350px; margin-right: 50px;">
      <div class="space-y-12">
        ...
        <div class="border-b border-gray-900/10 pb-12">
          <h2 class="text-4xl font-semibold leading-7 text-gray-900">Address Information</h2><br>
    
          <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div class="sm:col-span-3">
                <label for="country" class="block text-sm font-medium leading-6 text-gray-900">Country</label>
                <div class="mt-2">
                  <select v-model="country" id="country" name="country" autocomplete="country-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-deep-purple-accent-400 sm:max-w-xs sm:text-sm sm:leading-6">
              ...
              <div class="sm:col-span-2 sm:col-start-1">
                ...
                <div class="mt-2">
                  <input v-model="city" style="padding-left: 10px" type="text" name="city" id="city" autocomplete="address-level2" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-deep-purple-accent-400 sm:text-sm sm:leading-6" />
                </div>
              </div>
              ...
              <div class="sm:col-span-2">
                ...
                <div class="mt-2">
                  <input v-model="postalCode" style="padding-left: 10px" type="text" name="postalCode" id="postalCode" autocomplete="postalCode" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-deep-purple-accent-400 sm:text-sm sm:leading-6" />
                </div>
              </div>
            </div>
        </div>
              ...
              <div class="mt-6 space-y-6">
                <div class="relative flex gap-x-3">
                  <div class="flex h-6 items-center">
                    <input v-model="purchases" id="purchases" name="purchases" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-deep-purple-accent-400" />
                  </div>
    ...
    <form style="padding: 50px; background-color: white; border-radius: 10px; box-shadow: 1px 5px 8px grey; margin-left: 350px; margin-right: 50px;">
      <div class="space-y-12">
        <div class="border-b border-gray-900/10 pb-12">
          <h2 class="text-4xl font-semibold leading-7 text-gray-900">Account Creator</h2><br>
          <p class="mt-1 text-sm leading-6 text-gray-600">Enter Information Below To Create New User Accounts</p>
    
          <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div class="sm:col-span-3">
              <label for="familyId" class="block text-sm font-medium leading-6 text-gray-900">Family ID</label>
              <div class="mt-2">
                <input v-model="familyId" style="padding-left: 10px" disabled type="text" name="familyId" id="familyId" autocomplete="familyId" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-deep-purple-accent-400 sm:text-sm sm:leading-6" />
              </div>
            </div>

            <div class="sm:col-span-3">
              <div class="mt-2">
              <label for="newUserType" class="block text-sm font-medium leading-6 text-gray-900">Account Type</label>
              <select v-model="newUserType" required id="newUserType" name="newUserType" autocomplete="newUserType" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-deep-purple-accent-400 sm:text-sm sm:leading-6">
            ...
            <div class="sm:col-span-3">
              <label for="firstName" class="block text-sm font-medium leading-6 text-gray-900">First name</label>
              <div class="mt-2">
                <input v-model="newFirstName" required style="padding-left: 10px" type="text" name="firstName" id="firstName" autocomplete="firstName" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-deep-purple-accent-400 sm:text-sm sm:leading-6" />
              </div>
            </div>
            ...
            <div class="sm:col-span-3">
              <label for="surname" class="block text-sm font-medium leading-6 text-gray-900">Last name</label>
              <div class="mt-2">
                <input v-model="newSurname" required style="padding-left: 10px" type="text" name="surname" id="surname" autocomplete="surname" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-deep-purple-accent-400 sm:text-sm sm:leading-6" />
              </div>
            </div>
            ...
            <div class="sm:col-span-3">
              <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Email address</label>
              <div class="mt-2">
                <input v-model="newEmail" required style="padding-left: 10px" id="email" name="email" type="email" autocomplete="email" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-deep-purple-accent-400 sm:text-sm sm:leading-6" />
              </div>
            </div>
            ...
            <div class="sm:col-span-3">
              ...
              <div class="mt-2">
                <input v-model="newPassword" required style="padding-left: 10px" id="password" name="password" type="password" autocomplete="password" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-deep-purple-accent-400 sm:text-sm sm:leading-6" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
        <form style="width: 100%;" @submit.prevent="setNewUserData">
          <button type="submit" class="rounded-md bg-blue-400 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Save</button>
        </form>
      </div>
    ...
    async function getFamilyData () {
      try {
        const response = await fetch(`https://localhost:7249/api/Family/GetFamilyId/`+ sessionStorage.getItem('334_group_user_userId'), {
          credentials: 'include'
        });
        const data = await response.json();
        isLoading.value = false;
    ...
    async function setUserData () {
      const userData = {
        ...
        purchaseNotifications: purchases.value,
        shippingNotifications: shipping.value,
        storeNotifications: stores.value
      }
    ...
    (async () => {
      try {        
        ...
        firstName.value = userData.givenName;
        surname.value = userData.surname;
        email.value = userData.email;
        streetAddress.value = userData.street;
        city.value  = userData.city;
        region.value = userData.state;
